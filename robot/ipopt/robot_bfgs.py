...
# Initial condition
vmin[0] = vmax[0] = v0[0] = X[0,N_sim/2]
vmin[1] = vmax[1] = v0[1] = X[0,N_sim/2]
vmin[2] = vmax[2] = v0[2] = X[0,N_sim/2]
vmin[3] = vmax[3] = v0[3] = X[0,N_sim/2]
vmin[4] = vmax[4] = v0[4] = X[0,N_sim/2]
vmin[5] = vmax[5] = v0[5] = X[0,N_sim/2]
...
# Store results
savez('robot_sim_ipopt_bfgs.mpy', X=X, U=U, time=time, full_time=full_time, iter=iter)
